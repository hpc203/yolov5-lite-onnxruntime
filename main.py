...
if __name__=='__main__':
    ...
    parser.add_argument('--imgpath', type=str, default='imgs/horse.jpg', help="image path")
    parser.add_argument('--modelpath', type=str, default='onnxmodel/v5lite-s.onnx', help="onnx filepath")
